<?php
    ...
    if ($_POST) {
	      ...
	      $returnFlag = $constantsManager->delete($constantsid);
        if ($returnFlag) {
	          $message = "成功删除变量信息";
...
<?php
    echo "<table width=\"100%\"  border=\"0\" cellpadding=\"0\" cellspacing=\"1\" {$strings['TABLE_LINK_BK_COLOR']} class=eng>
            ...
            <td colspan=\"2\" height=\"30\" class=hdr>删除常量，<font color=\"red\"><b>此删除不可逆！</b></font></td>
            </tr>
            ...
            <td height=\"27\">&nbsp;$typeStr
            </td>
            </tr>
            <tr{$strings['TABLE_DARK_COLOR']}>
            <td height=\"40\" colspan=\"2\" align=\"center\"><input type=\"submit\" name=\"Submit\" value=\"确认删除常量\"></td>
            </tr>
            </form>
            </table>";
?>