...
<?php
  ...
  if(!empty($msg)) {	
   ...
   //  $table .="<td height=\"30\" colspan=\"9\" class=hdr>Kia Ora $consumerName&nbsp;，您的拼单订单详情</td>";
   //}else{
     $table .="<td height=\"30\" colspan=\"9\" class=hdr>Kia Ora $consumerName&nbsp;，您的订单详情</td>";
   //}
   $table .="</tr>";
   $table .="<tr $bgcolor1 align=\"center\">";
   if($idcode){
     $table .="<td height=\"27\">&nbsp;识别码</td>";
   ...
   $table .="<tr $bgcolor2 align=\"center\">";
   $table .="<td height=\"27\" align=\"left\">&nbsp;应付</td>";
   $table .="<td height=\"27\" align=\"right\">&nbsp;$price&nbsp;元人民币</td>";
   $table .="</tr>";
   if($memo){
   $table .="<tr $bgcolor2 align=\"center\">";
   $table .="<td height=\"27\" align=\"left\">&nbsp;备注</td>";
   $table .="<td height=\"27\" align=\"right\">$memo</td>";
   $table .="</tr>";
   $table .="</table>";
   }
   $table .= "</td>";
